import { a as e, c as t, m as n, p as r } from "./editor.api-Ck4Uxo0P.js";
import "./monaco-editor-core-Cf4ZaCSP.js";
var i = 120 * 1e3,
    a = (function () {
        function e(e) {
            var t = this;
        ...
        return (
            ...
            (e.prototype._checkIfIdle = function () {
                this._worker && Date.now() - this._lastUsedTime > i && this._stopWorker();
            }),
            (e.prototype._getClient = function () {
                return (
                    (this._lastUsedTime = Date.now()),
                    (this._client ||=
                        ((this._worker = r.createWebWorker({
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return z.objectLiteral(t) && z.uinteger(t.line) && z.uinteger(t.character);
    }
    e.is = n;
})((c ||= {}));
var l;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return z.objectLiteral(t) && c.is(t.start) && c.is(t.end);
    }
    e.is = n;
})((l ||= {}));
var u;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return z.defined(t) && l.is(t.range) && (z.string(t.uri) || z.undefined(t.uri));
    }
    e.is = n;
})((u ||= {}));
var d;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            (l.is(t.targetSelectionRange) || z.undefined(t.targetSelectionRange)) &&
            (l.is(t.originSelectionRange) || z.undefined(t.originSelectionRange))
        );
    }
    e.is = n;
})((d ||= {}));
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return l.is(t.range) && f.is(t.color);
    }
    e.is = n;
})((p ||= {}));
var m;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            z.string(t.label) &&
            (z.undefined(t.textEdit) || x.is(t)) &&
            (z.undefined(t.additionalTextEdits) || z.typedArray(t.additionalTextEdits, x.is))
        );
    }
    e.is = n;
})((m ||= {}));
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return z.defined(t) && u.is(t.location) && z.string(t.message);
    }
    e.is = n;
})((_ ||= {}));
var v;
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            (z.undefined(t.codeDescription) || z.string(t.codeDescription?.href)) &&
            (z.string(t.source) || z.undefined(t.source)) &&
            (z.undefined(t.relatedInformation) || z.typedArray(t.relatedInformation, _.is))
        );
    }
    e.is = n;
})((y ||= {}));
...
(function (e) {
    ...
    function i(e) {
        var t = e;
        return z.objectLiteral(t) && z.string(t.newText) && l.is(t.range);
    }
    e.is = i;
})((x ||= {}));
var S;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            z.objectLiteral(t) &&
            z.string(t.label) &&
            (z.boolean(t.needsConfirmation) || t.needsConfirmation === void 0) &&
...
(function (e) {
    ...
    function i(e) {
        var t = e;
        return x.is(t) && (S.is(t.annotationId) || C.is(t.annotationId));
    }
    e.is = i;
})((w ||= {}));
var T;
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            z.string(t.uri) &&
            (t.options === void 0 ||
                ((t.options.overwrite === void 0 || z.boolean(t.options.overwrite)) &&
                    (t.options.ignoreIfExists === void 0 ||
                        z.boolean(t.options.ignoreIfExists)))) &&
            (t.annotationId === void 0 || C.is(t.annotationId))
        );
    }
    e.is = n;
})((E ||= {}));
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            z.string(t.uri) &&
            (t.options === void 0 ||
                ((t.options.recursive === void 0 || z.boolean(t.options.recursive)) &&
        ...
        return (
            ...
            (t.documentChanges === void 0 ||
                t.documentChanges.every(function (e) {
                    return z.string(e.kind) ? E.is(e) || D.is(e) || O.is(e) : T.is(e);
                }))
        );
    }
    e.is = t;
...
var A = (function () {
        ...
        return (
            ...
            (e.prototype.assertChangeAnnotations = function (e) {
                if (e === void 0)
                    throw Error(`Text edit change is not configured to manage change annotations.`);
            }),
            e
        );
    })(),
    ...
    return (
            ...
            if (M.is(e)) {
                ...
                if (!n) {
                    ...
                    (this._workspaceEdit.documentChanges.push(i),
                        (n = new A(r, this._changeAnnotations)),
                        (this._textEditChanges[t.uri] = n));
                }
                return n;
            } else {
                if ((this.initChanges(), this._workspaceEdit.changes === void 0))
                    throw Error(`Workspace edit is not configured for normal text edit changes.`);
        ...
        (e.prototype.createFile = function (e, t, n) {
            if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw Error(`Workspace edit is not configured for document changes.`);
            var r;
            S.is(t) || C.is(t) ? (r = t) : (n = t);
            var i, a;
            if (
                (r === void 0
                    ? (i = E.create(e, n))
                    : ((a = C.is(r) ? r : this._changeAnnotations.manage(r)),
                      (i = E.create(e, n, a))),
                this._workspaceEdit.documentChanges.push(i),
                a !== void 0)
            )
        ...
        (e.prototype.renameFile = function (e, t, n, r) {
            if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw Error(`Workspace edit is not configured for document changes.`);
            var i;
            S.is(n) || C.is(n) ? (i = n) : (r = n);
            var a, o;
            if (
                (i === void 0
                    ? (a = D.create(e, t, r))
                    : ((o = C.is(i) ? i : this._changeAnnotations.manage(i)),
                      (a = D.create(e, t, r, o))),
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return z.defined(t) && z.string(t.uri) && (t.version === null || z.integer(t.version));
    }
    e.is = n;
})((M ||= {}));
var ie;
...
(function (e) {
    function t(e) {
        var t = e;
        return z.objectLiteral(e) && N.is(t.kind) && z.string(t.value);
    }
    e.is = t;
})((P ||= {}));
var F;
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return t && z.string(t.newText) && l.is(t.insert) && l.is(t.replace);
    }
    e.is = n;
})((oe ||= {}));
var se;
...
(function (e) {
    function t(e) {
        ...
        return (
            !!t &&
            z.objectLiteral(t) &&
            (P.is(t.contents) || L.is(t.contents) || z.typedArray(t.contents, L.is)) &&
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            z.defined(t) &&
            z.typedArray(t.diagnostics, y.is) &&
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            t &&
            z.string(t.title) &&
            (t.diagnostics === void 0 || z.typedArray(t.diagnostics, y.is)) &&
            (t.kind === void 0 || z.string(t.kind)) &&
            (t.edit !== void 0 || t.command !== void 0) &&
            (t.command === void 0 || b.is(t.command)) &&
            (t.isPreferred === void 0 || z.boolean(t.isPreferred)) &&
            (t.edit === void 0 || k.is(t.edit))
        );
    }
    e.is = n;
})((be ||= {}));
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return z.defined(t) && l.is(t.range) && (z.undefined(t.command) || b.is(t.command));
    }
    e.is = n;
})((xe ||= {}));
var Se;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return z.defined(t) && z.uinteger(t.tabSize) && z.boolean(t.insertSpaces);
    }
    e.is = n;
})((Se ||= {}));
var Ce;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return z.defined(t) && l.is(t.range) && (z.undefined(t.target) || z.string(t.target));
    }
    e.is = n;
})((Ce ||= {}));
var we;
(function (e) {
    ...
    function n(t) {
        var n = t;
        return n !== void 0 && l.is(n.range) && (n.parent === void 0 || e.is(n.parent));
    }
    e.is = n;
})((we ||= {}));
var Te;
(function (e) {
    ...
    function r(e, t) {
        for (
            ...
            if (l <= a) n = n.substring(0, c) + s.newText + n.substring(l, n.length);
    ...
    function i(e, t) {
        ...
        var n = (e.length / 2) | 0,
            ...
            a = e.slice(n);
        (i(r, t), i(a, t));
        for (var o = 0, s = 0, c = 0; o < r.length && s < a.length; )
                    ...
                    ((i._listener[e.uri.toString()] = e.onDidChangeContent(function () {
                        (clearTimeout(n),
                            (n = window.setTimeout(function () {
                                return i._doValidate(e.uri, t);
                            }, 500)));
                    })),
                        i._doValidate(e.uri, t));
                }
            },
            o = function (e) {
                r.setModelMarkers(e, i._languageId, []);
                var t = e.uri.toString(),
                    n = i._listener[t];
                n && (n.dispose(), delete i._listener[t]);
            };
        (this._disposables.push(r.onDidCreateModel(a)),
            this._disposables.push(
                r.onWillDisposeModel(function (e) {
                    (o(e), i._resetSchema(e.uri));
                }),
            ),
            this._disposables.push(
                r.onDidChangeModelLanguage(function (e) {
                    (o(e.model), a(e.model), i._resetSchema(e.model.uri));
                }),
            ),
            this._disposables.push(
                n.onDidChange(function (e) {
                    r.getModels().forEach(function (e) {
                        e.getLanguageId() === i._languageId && (o(e), a(e));
                    });
                }),
            ),
            this._disposables.push({
                dispose: function () {
                    for (var e in (r.getModels().forEach(o), i._listener)) i._listener[e].dispose();
                },
            }),
            r.getModels().forEach(a));
    }
    return (
        (e.prototype.dispose = function () {
                ...
                .then(function (n) {
                    return n.doValidation(e.toString()).then(function (n) {
                        var i = n.map(function (t) {
                            ...
                            a = r.getModel(e);
                        a && a.getLanguageId() === t && r.setModelMarkers(a, t, i);
                    });
                })
...
function ke(e, t) {
    var n = typeof t.code == `number` ? String(t.code) : t.code;
    return {
        severity: Oe(t.severity),
...
function H(e) {
    if (e)
        return new t(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1);
}
function Ae(e) {
    return e.insert !== void 0 && e.replace !== void 0;
}
function je(e) {
    var t = n.CompletionItemKind;
    switch (e) {
        case F.Text:
            return t.Text;
        case F.Method:
...
function U(e) {
    if (e) return { range: H(e.range), text: e.newText };
}
function Me(e) {
...
var Ne = (function () {
    ...
    return (
        ...
        (e.prototype.provideCompletionItems = function (e, r, i, a) {
            var o = e.uri;
            return this._worker(o)
                .then(function (e) {
                    return e.doComplete(o.toString(), B(r));
                })
                .then(function (i) {
                    if (i) {
                        var a = e.getWordUntilPosition(r),
                            o = new t(r.lineNumber, a.startColumn, r.lineNumber, a.endColumn),
                            s = i.items.map(function (e) {
                                ...
                                return (
                                    e.textEdit &&
                                        (Ae(e.textEdit)
                                            ? (t.range = {
                                                  insert: H(e.textEdit.insert),
                                                  replace: H(e.textEdit.replace),
                                              })
                                            : (t.range = H(e.textEdit.range)),
                                        (t.insertText = e.textEdit.newText)),
                                    e.additionalTextEdits &&
                                        (t.additionalTextEdits = e.additionalTextEdits.map(U)),
                                    e.insertTextFormat === I.Snippet &&
                                        (t.insertTextRules =
                                            n.CompletionItemInsertTextRule.InsertAsSnippet),
                                    t
                                );
                            });
...
function Fe(e) {
    if (e) return Array.isArray(e) ? e.map(W) : [W(e)];
}
var Ie = (function () {
    function e(e) {
        this._worker = e;
    ...
    return (
        (e.prototype.provideHover = function (e, t, n) {
            ...
            return this._worker(r)
                .then(function (e) {
                    return e.doHover(r.toString(), B(t));
                })
                .then(function (e) {
                    if (e) return { range: H(e.range), contents: Fe(e.contents) };
                });
        }),
        e
    );
                    ...
                    if (e)
                        return e.map(function (e) {
                            return {
                                ...
                                kind: Le(e.kind),
                                range: H(e.location.range),
                                selectionRange: H(e.location.range),
                                tags: [],
                            };
                        });
                });
            ...
            (e.prototype.provideDocumentFormattingEdits = function (e, t, n) {
                ...
                return this._worker(r).then(function (e) {
                    return e.format(r.toString(), null, G(t)).then(function (e) {
                        if (!(!e || e.length === 0)) return e.map(U);
                    });
                });
            }),
            e
        ...
        return (
            (e.prototype.provideDocumentRangeFormattingEdits = function (e, t, n, r) {
                ...
                return this._worker(i).then(function (e) {
                    return e.format(i.toString(), V(t), G(n)).then(function (e) {
                        if (!(!e || e.length === 0)) return e.map(U);
                    });
                });
            }),
    ...
    Ve = (function () {
        ...
        return (
            (e.prototype.provideDocumentColors = function (e, t) {
                ...
                return this._worker(n)
                    ...
                    .then(function (e) {
                        if (e)
                            return e.map(function (e) {
                                return { color: e.color, range: H(e.range) };
                            });
                    });
            }),
            (e.prototype.provideColorPresentations = function (e, t, n) {
                ...
                return this._worker(r)
                    .then(function (e) {
                        return e.getColorPresentations(r.toString(), t.color, V(t.range));
                    })
                    .then(function (e) {
                        if (e)
                            return e.map(function (e) {
                    ...
                    .then(function (e) {
                        if (e)
                            return e.map(function (e) {
                                ...
                                return (e.kind !== void 0 && (t.kind = Ue(e.kind)), t);
                            });
                    });
            }),
            e
...
var We = (function () {
    ...
    return (
        (e.prototype.provideSelectionRanges = function (e, t, n) {
            ...
            return this._worker(r)
                .then(function (e) {
                    return e.getSelectionRanges(r.toString(), t.map(B));
                })
                .then(function (e) {
                    if (e)
                        return e.map(function (e) {
                            for (var t = []; e; ) (t.push({ range: H(e.range) }), (e = e.parent));
                            return t;
                        });
                });
        }),
...
function Ge(e, t) {
    ...
    function f(t, n) {
        for (var i = 0, a = 0; i < t || !n; ) {
            ...
            if (o >= 48 && o <= 57) a = a * 16 + o - 48;
            else if (o >= 65 && o <= 70) a = a * 16 + o - 65 + 10;
            else if (o >= 97 && o <= 102) a = a * 16 + o - 97 + 10;
            else break;
            (r++, i++);
        }
        return (i < t && (a = -1), a);
    ...
    function m() {
        ...
        else for (r++; r < e.length && J(e.charCodeAt(r)); ) r++;
        if (r < e.length && e.charCodeAt(r) === 46)
            if ((r++, r < e.length && J(e.charCodeAt(r))))
                for (r++; r < e.length && J(e.charCodeAt(r)); ) r++;
...
`;
                    ...
                    case 117:
                        var o = f(4, !0);
                        o >= 0 ? (t += String.fromCharCode(o)) : (d = 4);
                        break;
                    default:
                        d = 5;
                }
    ...
    function g() {
        ...
        if (K(t)) {
            do (r++, (i += String.fromCharCode(t)), (t = e.charCodeAt(r)));
            while (K(t));
            return (o = 15);
        }
        if (q(t))
        ...
        switch (t) {
            ...
            case 47:
                ...
                if (e.charCodeAt(r + 1) === 47) {
                    for (r += 2; r < n && !q(e.charCodeAt(r)); ) r++;
                    return ((i = e.substring(f, r)), (o = 12));
                }
                if (e.charCodeAt(r + 1) === 42) {
                    ...
                    for (var p = n - 1, g = !1; r < p; ) {
                        ...
                        (r++, q(v) && (v === 13 && e.charCodeAt(r) === 10 && r++, s++, (l = r)));
                    }
                    return (g || (r++, (d = 1)), (i = e.substring(f, r)), (o = 13));
                }
                return ((i += String.fromCharCode(t)), r++, (o = 16));
            case 45:
                if (((i += String.fromCharCode(t)), r++, r === n || !J(e.charCodeAt(r))))
                    return (o = 16);
            case 48:
            case 49:
            case 50:
...
function Je(e, t, n) {
    return (
        n === void 0 && (n = !1),
        (t >= e.offset && t < e.offset + e.length) || (n && t === e.offset + e.length)
    );
}
function Ye(e, t, n) {
    if ((n === void 0 && (n = !1), Je(e, t, n))) {
        var r = e.children;
        if (Array.isArray(r))
...
var X = `delimiter.bracket.json`,
    Z = `delimiter.array.json`,
    Qe = `delimiter.colon.json`,
    $e = `delimiter.comma.json`,
    et = `keyword.json`,
    tt = `keyword.json`,
    nt = `string.value.json`,
    rt = `number.json`,
    it = `string.key.json`,
    at = `comment.block.json`,
    ot = `comment.line.json`,
    Q = (function () {
        function e(e, t) {
                ...
                return t === this
                    ...
                    : !t || !(t instanceof e)
                      ...
                      : this.scanError === t.scanError &&
                        ...
                        Q.equals(this.parents, t.parents);
            }),
...
function st(e, t, n, r, i) {
    ...
    for (
        var s = Xe(t), c = n.lastWasColon, l = n.parents, u = { tokens: [], endState: n.clone() };
        ;
    ) {
        var d = r + s.getPosition(),
            f = ``,
            p = s.scan();
        if (p === 17) break;
        if (d === r + s.getPosition())
            throw Error(
                `Scanner did not advance, next 3 characters are: ` + t.substr(s.getPosition(), 3),
            );
        switch ((o && (d -= a), (o = a > 0), p)) {
            case 1:
                ((l = Q.push(l, 0)), (f = X), (c = !1));
                break;
            case 2:
                ((l = Q.pop(l)), (f = X), (c = !1));
                break;
            case 3:
                ((l = Q.push(l, 1)), (f = Z), (c = !1));
                break;
            case 4:
                ((l = Q.pop(l)), (f = Z), (c = !1));
                break;
        ...
        ((u.endState = new $(n.getStateData(), s.getTokenError(), c, l)),
            u.tokens.push({ startIndex: d, scopes: f }));
    }
    return u;
}
function ct(e) {
    ...
    function s() {
        ...
        (ut(r),
            i.documentFormattingEdits &&
                r.push(n.registerDocumentFormattingEditProvider(t, new ze(o))),
            i.documentRangeFormattingEdits &&
                r.push(n.registerDocumentRangeFormattingEditProvider(t, new Be(o))),
            i.completionItems && r.push(n.registerCompletionItemProvider(t, new Ne(o))),
            i.hovers && r.push(n.registerHoverProvider(t, new Ie(o))),
            i.documentSymbols && r.push(n.registerDocumentSymbolProvider(t, new Re(o))),
            i.tokens && r.push(n.setTokensProvider(t, Ze(!0))),
            i.colors && r.push(n.registerColorProvider(t, new Ve(o))),
            i.foldingRanges && r.push(n.registerFoldingRangeProvider(t, new He(o))),
            i.diagnostics && r.push(new De(t, o, e)),
            i.selectionRanges && r.push(n.registerSelectionRangeProvider(t, new We(o))));
    }
    (s(), t.push(n.setLanguageConfiguration(e.languageId, dt)));
    var c = e.modeConfiguration;
    return (
        e.onDidChange(function (e) {
            e.modeConfiguration !== c && ((c = e.modeConfiguration), s());
        }),
        t.push(lt(r)),
        lt(t)
    );
