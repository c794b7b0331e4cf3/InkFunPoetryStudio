import { Ba as e } from "./index-zRImlZB6.js";
e([
    {
        name: `IF`,
...
等价于直接用JS表达式如：condition ? consequent : alternate。`,
        ...
        params: [
            { type: `expression`, name: `condition`, description: `条件表达式。例如：语文成绩>80` },
            { type: `any`, name: `consequent`, description: `条件判断通过的返回结果` },
            { type: `any`, name: `alternate`, description: `条件判断不通过的返回结果` },
        ],
        returns: { type: `any`, description: `根据条件返回不同的结果` },
        namespace: `逻辑函数`,
    },
    {
        name: `AND`,
...
等价于直接用JS表达式如：语文成绩>80 && 数学成绩>80。`,
        ...
        returns: { type: `boolean`, description: null },
        namespace: `逻辑函数`,
    },
    {
        name: `OR`,
...
如果语文成绩大于 80，则返回优秀，否则判断大于 60 分，则返回良，否则返回继续努力。`,
        ...
        params: [
            ...
            { type: `...any`, name: `result`, description: `返回值` },
        ],
        returns: { type: `any`, description: `第一个满足条件的结果，没有命中的返回 false。` },
        namespace: `逻辑函数`,
    },
    {
        name: `ABS`,
        ...
        example: `ABS(num)`,
        params: [{ type: `number`, name: `num`, description: `数值` }],
        returns: { type: `number`, description: `传入数值的绝对值` },
        namespace: `数学函数`,
    },
    {
        name: `MAX`,
        ...
        params: [{ type: `...number`, name: `num`, description: `数值` }],
        returns: { type: `number`, description: `所有传入值中最大的那个` },
        namespace: `数学函数`,
    },
    {
        name: `MIN`,
        ...
        params: [{ type: `...number`, name: `num`, description: `数值` }],
        returns: { type: `number`, description: `所有传入值中最小的那个` },
        namespace: `数学函数`,
    },
    {
        name: `SUM`,
        ...
        params: [{ type: `...number`, name: `num`, description: `数值` }],
        returns: { type: `number`, description: `所有传入数值的总和` },
        namespace: `数学函数`,
    },
    {
        name: `INT`,
        ...
        example: `INT(num)`,
        params: [{ type: `number`, name: `num`, description: `数值` }],
        returns: { type: `number`, description: `数值对应的整形` },
        namespace: `数学函数`,
    },
    {
        name: `MOD`,
        ...
        params: [
            { type: `number`, name: `num`, description: `被除数` },
            { type: `number`, name: `divisor`, description: `除数` },
        ],
        returns: { type: `number`, description: `两数相除的余数` },
        namespace: `数学函数`,
    },
    {
        name: `PI`,
        ...
        example: `PI()`,
        params: [],
        returns: { type: `number`, description: `圆周率数值` },
        namespace: `数学函数`,
    },
    {
        name: `ROUND`,
        ...
        params: [
            { type: `number`, name: `num`, description: `要处理的数字` },
            { type: `number`, name: `numDigits`, description: `小数位数，默认为2` },
        ],
        returns: { type: `number`, description: `传入数值四舍五入后的结果` },
        namespace: `数学函数`,
    },
    {
        name: `FLOOR`,
    ...
    },
    {
        ...
        returns: { type: `number`, description: `传入数值向上取整后的结果` },
        namespace: `数学函数`,
    },
    {
        name: `SQRT`,
        ...
        example: `SQRT(num)`,
        params: [{ type: `number`, name: `num`, description: `要处理的数字` }],
        returns: { type: `number`, description: `开平方的结果` },
        namespace: `数学函数`,
    },
    {
        name: `AVG`,
        ...
        params: [{ type: `...number`, name: `num`, description: `要处理的数字` }],
        returns: { type: `number`, description: `所有数值的平均值` },
        namespace: `数学函数`,
    },
    {
        name: `DEVSQ`,
    ...
    },
    {
        ...
        params: [
            { type: `array`, name: `nums`, description: `要处理的数字` },
            { type: `number`, name: `k`, description: `第几大` },
        ],
        returns: { type: `number`, description: `所有数值的平均值` },
        namespace: `数学函数`,
    },
    {
        ...
        params: [{ type: `number`, name: `num`, description: `要处理的数字` }],
        returns: { type: `string`, description: `数值中文大写字符` },
        namespace: `数学函数`,
    },
    {
        name: `RAND`,
...
返回 0-100 之间的随机数。`,
    ...
    },
    {
        ...
        description: `取数据最后一个。`,
        example: `LAST(array)`,
        params: [{ type: `...number`, name: `arr`, description: `要处理的数组` }],
        returns: { type: `any`, description: `最后一个值` },
        namespace: `数学函数`,
    },
    {
        name: `POW`,
        ...
        params: [
            { type: `number`, name: `base`, description: `基数` },
            { type: `number`, name: `exponent`, description: `指数` },
        ],
        returns: { type: `number`, description: `基数的指数次幂` },
        namespace: `数学函数`,
    },
    {
        name: `LEFT`,
        ...
        params: [
            ...
            { type: `number`, name: `len`, description: `要处理的长度` },
        ],
        returns: { type: `string`, description: `对应字符串` },
        namespace: `文本函数`,
    },
    {
        name: `RIGHT`,
    ...
    },
    {
        ...
        description: `计算文本的长度。`,
        example: `LEN(text)`,
        params: [{ type: `string`, name: `text`, description: `要处理的文本` }],
        returns: { type: `number`, description: `长度` },
        namespace: `文本函数`,
    },
    {
        name: `LENGTH`,
        ...
        params: [{ type: `Array<string>`, name: `textArr`, description: `要处理的文本集合` }],
        returns: { type: `Array<number>`, description: `长度集合` },
        namespace: `文本函数`,
    },
    {
        name: `ISEMPTY`,
        ...
        params: [{ type: `string`, name: `text`, description: `要处理的文本` }],
        returns: { type: `boolean`, description: `判断结果` },
        namespace: `文本函数`,
    },
    {
        name: `CONCATENATE`,
        ...
        params: [{ type: `...string`, name: `text`, description: `文本集合` }],
        returns: { type: `string`, description: `连接后的文本` },
        namespace: `文本函数`,
    },
    {
        name: `CHAR`,
...
示例：\`CHAR(97)\` 等价于 "a"。`,
        example: `CHAR(code)`,
        params: [{ type: `number`, name: `code`, description: `编码值` }],
        returns: { type: `string`, description: `指定位置的字符` },
        namespace: `文本函数`,
    },
    {
        name: `LOWER`,
        ...
        example: `LOWER(text)`,
        params: [{ type: `string`, name: `text`, description: `文本` }],
        returns: { type: `string`, description: `结果文本` },
        namespace: `文本函数`,
    },
    {
        name: `UPPER`,
...
返回 \`06\`。`,
        ...
        params: [
            { type: `string`, name: `text`, description: `文本` },
            { type: `number`, name: `num`, description: `目标长度` },
            { type: `string`, name: `pad`, description: `用于补齐的文本` },
        ],
        returns: { type: `string`, description: `结果文本` },
        namespace: `文本函数`,
    },
...
返回 \`amis...\`。`,
        ...
        params: [
            { type: `string`, name: `text`, description: `文本` },
            { type: `number`, name: `text`, description: `最长长度` },
        ],
        returns: { type: `string`, description: `结果文本` },
        namespace: `文本函数`,
    },
    {
        ...
        params: [
            { type: `string`, name: `text`, description: `文本` },
            { type: `string`, name: `delimiter`, description: `结束文本` },
        ],
        returns: { type: `string`, description: `判断结果` },
        namespace: `文本函数`,
    },
    {
        name: `SPLIT`,
...
返回 \`["a", "b", "c"]\`。`,
        ...
        params: [
            { type: `string`, name: `text`, description: `文本` },
            { type: `string`, name: `delimiter`, description: `文本片段` },
        ],
        returns: { type: `Array<string>`, description: `文本集` },
        namespace: `文本函数`,
    },
    {
        name: `TRIM`,
        ...
        example: `TRIM(text)`,
        params: [{ type: `string`, name: `text`, description: `文本` }],
        returns: { type: `string`, description: `处理后的文本` },
        namespace: `文本函数`,
    },
    {
        name: `STRIPTAG`,
...
返回：\`amis\`。`,
    ...
    },
    {
        ...
        params: [
            { type: `string`, name: `text`, description: `文本` },
            { type: `string`, name: `endString`, description: `结束文本` },
        ],
        returns: { type: `string`, description: `判断结果` },
        namespace: `文本函数`,
    },
    {
        ...
        params: [
            { type: `string`, name: `text`, description: `文本` },
            { type: `string`, name: `searchText`, description: `搜索文本` },
        ],
        returns: { type: `string`, description: `判断结果` },
        namespace: `文本函数`,
    },
    {
        ...
        params: [
            { type: `string`, name: `text`, description: `要处理的文本` },
            { type: `string`, name: `search`, description: `要被替换的文本` },
            { type: `string`, name: `replace`, description: `要替换的文本` },
        ],
        returns: { type: `string`, description: `处理结果` },
        namespace: `文本函数`,
    },
    {
        name: `SEARCH`,
        ...
        params: [
            { type: `string`, name: `text`, description: `要处理的文本` },
            { type: `string`, name: `search`, description: `用来搜索的文本` },
            { type: `number`, name: `start`, description: `起始位置` },
        ],
        returns: { type: `number`, description: `命中的位置` },
        namespace: `文本函数`,
    },
    {
        name: `MID`,
        ...
        params: [
            { type: `string`, name: `text`, description: `要处理的文本` },
            { type: `number`, name: `from`, description: `起始位置` },
            { type: `number`, name: `len`, description: `处理长度` },
        ],
        returns: { type: `number`, description: `命中的位置` },
        namespace: `文本函数`,
    },
...
返回：a.json\`。`,
        ...
        params: [{ type: `string`, name: `text`, description: `要处理的文本` }],
        returns: { type: `string`, description: `文件名` },
        namespace: `文本函数`,
    },
    {
        name: `UUID`,
        ...
        example: `UUID(8)`,
        params: [
            { type: `number`, name: `length`, description: `生成的UUID字符串长度，默认为32位` },
        ],
...
即如果是12月份，你应该传入数值11。`,
        ...
        params: [],
        returns: { type: `Date`, description: `日期对象` },
        namespace: `日期函数`,
    },
    {
        name: `TIMESTAMP`,
        ...
        params: [
            { type: `date`, name: `date`, description: `日期对象` },
            {
                type: `string`,
                name: `format`,
        ...
        returns: { type: `number`, description: `时间戳` },
        namespace: `日期函数`,
    },
    {
        name: `TODAY`,
        ...
        example: `TODAY()`,
        params: [],
        returns: { type: `number`, description: `日期` },
        namespace: `日期函数`,
    },
    {
        name: `NOW`,
...
WEEKDAY('2023-02-27', 2) 得到 1。`,
        ...
        params: [
            { type: `any`, name: `date`, description: `日期` },
            {
                type: `number`,
                name: `type`,
        ...
        returns: { type: `number`, description: `星期几的数字标识` },
        namespace: `日期函数`,
    },
    {
        name: `WEEK`,
...
DATETOSTR(DATE('2021-12-21'), 'YYYY.MM.DD hh:mm:ss') 得到 '2021.12.21 08:00:00'。`,
        ...
        params: [
            { type: `any`, name: `date`, description: `日期对象、日期字符串、时间戳` },
            {
                type: `string`,
                name: `format`,
        ...
        returns: { type: `string`, description: `日期字符串` },
        namespace: `日期函数`,
    },
    {
        name: `DATERANGESPLIT`,
...
DATERANGESPLIT('1676563200, 1676735999', 'end' , 'YYYY.MM.DD hh:mm:ss') 得到 '2023.02.18 11:59:59'。`,
        ...
        params: [
            { type: `string`, name: `date`, description: `日期范围字符串` },
            {
                type: `string`,
                name: `key`,
                description: `取值标识，0或'start'表示获取开始时间，1或'end'表示获取结束时间`,
            },
            { type: `string`, name: `format`, description: `日期格式，可选` },
            { type: `string`, name: `delimiter`, description: `分隔符，可选，默认为','` },
        ],
        returns: { type: `string`, description: `日期字符串` },
        namespace: `日期函数`,
    },
    {
        ...
        returns: { type: `date`, description: `新的日期对象` },
        namespace: `日期函数`,
    },
    {
        name: `ENDOF`,
    ...
    },
    {
        ...
        description: `返回日期的年份。`,
        example: `YEAR(date)`,
        params: [{ type: `date`, name: `date`, description: `日期对象` }],
        returns: { type: `number`, description: `数值` },
        namespace: `日期函数`,
    },
    {
        name: `MONTH`,
    ...
    },
    {
        ...
        params: [
            { type: `date`, name: `endDate`, description: `日期对象` },
            { type: `date`, name: `startDate`, description: `日期对象` },
        ],
        returns: { type: `number`, description: `数值` },
        namespace: `日期函数`,
    },
...
对日期 A 进行往前减2月的操作。`,
        ...
        params: [
            { type: `date`, name: `date`, description: `日期对象` },
            { type: `number`, name: `num`, description: `数值` },
            { type: `string`, name: `unit`, description: `单位：支持年、月、天等等` },
        ],
        returns: { type: `date`, description: `日期对象` },
        namespace: `日期函数`,
    },
...
示例：STRTODATE('2021/12/6', 'YYYY/MM/DD')`,
        ...
        params: [
            { type: `string`, name: `value`, description: `日期字符` },
            { type: `string`, name: `format`, description: `日期格式` },
        ],
        returns: { type: `date`, description: `日期对象` },
        namespace: `日期函数`,
    },
    {
        ...
        params: [
            { type: `date`, name: `a`, description: `第一个日期` },
            { type: `date`, name: `b`, description: `第二个日期` },
            { type: `string`, name: `unit`, description: `单位，默认是 'day'， 即之比较到天` },
        ],
        returns: { type: `boolean`, description: `判断结果` },
        namespace: `日期函数`,
    },
...
示例：BETWEENRANGE('2021/12/6', ['2021/12/5','2021/12/7'])。`,
        ...
        params: [
            { type: `any`, name: `date`, description: `第一个日期` },
            { type: `Array<any>`, name: `daterange`, description: `日期范围` },
            { type: `string`, name: `unit`, description: `单位，默认是 'day'， 即之比较到天` },
            {
                type: `string`,
                name: `inclusivity`,
    ...
    },
    {
        ...
        description: `返回数组的长度。`,
        example: `COUNT(arr)`,
        params: [{ type: `Array<any>`, name: `arr`, description: `数组` }],
        returns: { type: `boolean`, description: `结果` },
        namespace: `数组`,
    },
    {
        name: `ARRAYMAP`,
        ...
        params: [
            { type: `Array<any>`, name: `arr`, description: `数组` },
            { type: `Array<any>`, name: `iterator`, description: `箭头函数` },
        ],
        returns: { type: `boolean`, description: `结果` },
        namespace: `数组`,
    },
...
ARRAYFIND([0, 2, false], item => item === 2) 得到 2。`,
        ...
        returns: { type: `any`, description: `结果` },
        namespace: `数组`,
    },
    {
        name: `ARRAYSOME`,
...
ARRAYINCLUDES([0, 2, false], 2) 得到 true。`,
        ...
        params: [
            { type: `Array<any>`, name: `arr`, description: `数组` },
            { type: `any`, name: `item`, description: `元素` },
        ],
        returns: { type: `any`, description: `结果` },
        namespace: `数组`,
    },
...
COMPACT([0, 1, false, 2, '', 3]) 得到 [1, 2, 3]。`,
        example: `COMPACT(arr)`,
        params: [{ type: `Array<any>`, name: `arr`, description: `数组` }],
        returns: { type: `Array<any>`, description: `结果` },
        namespace: `数组`,
    },
    {
        name: `JOIN`,
...
JOIN(['a', 'b', 'c'], '=') 得到 'a=b=c'。`,
        ...
        params: [
            { type: `Array<any>`, name: `arr`, description: `数组` },
            { type: `String`, name: `separator`, description: `分隔符` },
        ],
        returns: { type: `String`, description: `结果` },
        namespace: `数组`,
    },
    {
        name: `CONCAT`,
...
UNIQ([{a: '1'}, {b: '2'}, {a: '1'}]， 'id')。`,
        ...
        params: [
            { type: `Array<any>`, name: `arr`, description: `数组` },
            { type: `string`, name: `field`, description: `字段` },
        ],
        returns: { type: `Array<any>`, description: `结果` },
        namespace: `数组`,
    },
...
ENCODEJSON({name: 'amis'}) 得到 '{"name":"amis"}'。`,
        ...
        params: [{ type: `object`, name: `obj`, description: `JS对象` }],
        returns: { type: `string`, description: `结果` },
        namespace: `编码`,
    },
    {
...
DECODEJSON('{\\"name\\": "amis"}') 得到 {name: 'amis'}。`,
        ...
        params: [{ type: `string`, name: `str`, description: `字符串` }],
...
GET({arr: [{name: 'amis', age: 18}]}, 'arr.1.name', 'not-found') 得到 'not-found'。`,
        example: `GET(arr, 2)`,
        params: [
            { type: `any`, name: `obj`, description: `对象或数组` },
            { type: `string`, name: `path`, description: `路径` },
            { type: `any`, name: `defaultValue`, description: `如果解析不到则返回该值` },
        ],
        returns: { type: `any`, description: `结果` },
        namespace: `其他`,
    },
    {
        ...
        params: [{ type: `string`, name: `判断对象`, description: null }],
        returns: { type: `boolean`, description: `结果` },
        namespace: `其他`,
    },
]);