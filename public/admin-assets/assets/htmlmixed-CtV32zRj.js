...
import { t as n } from "./javascript-Ba0lNVZo.js";
var r = e((e, n) => {
        (function (r) {
            ...
            (e.defineMode(`xml`, function (r, i) {
                            ...
                            ? e.eat(`[`)
                                ...
                                : e.match(`--`)
                                  ...
                                  : e.match(`DOCTYPE`, !0, !0)
                                    ...
                                    : null
                            : e.eat(`?`)
                              ? (e.eatWhile(/[\w\._\-]/), (t.tokenize = m(`meta`, `?>`)), `meta`)
                ...
                function _(e, t, n) {
                    ((this.prev = e.context),
                        ...
                        (this.startOfLine = n),
                        (o.doNotIndent.hasOwnProperty(t) || (e.context && e.context.noIndent)) &&
                            (this.noIndent = !0));
                }
                function v(e) {
                ...
                function E(e, t, n) {
                    return e == `equals` ? D : (o.allowMissing || (u = `error`), T(e, t, n));
                }
                function D(e, t, n) {
                    return e == `string`
                        ? O
                ...
                return {
                    ...
                    indent: function (t, n, r) {
                        ...
                        if (t.tokenize.isInAttribute)
                            return t.tagStart == t.indented ? t.stringStartCol + 1 : t.indented + a;
        ...
        (function (r) {
            ...
            e.defineMode(`css`, function (t, n) {
                ...
                function C(e, t) {
                    ...
                    if (n == `"` || n == `'`) return ((t.tokenize = w(n)), t.tokenize(e, t));
                ...
                function D(e, t, n, r) {
                    return (
                        (e.context = new E(n, t.indentation() + (r === !1 ? 0 : i), e.context)), n
                    );
                }
                function O(e) {
                ...
                function j(e) {
                    ...
                    x = h.hasOwnProperty(t) ? `atom` : m.hasOwnProperty(t) ? `keyword` : `variable`;
                }
                var M = {};
                return (
                    ...
                    (M.at = function (e, t, n) {
                        return e == `;`
                            ...
                            : e == `{` || e == `}`
                              ? A(e, t, n)
                              : (e == `word` ? (x = `tag`) : e == `hash` && (x = `builtin`), `at`);
                    }),
            ...
            var n = [`domain`, `regexp`, `url`, `url-prefix`],
                ...
                y = t(v),
                b = n.concat(i).concat(o).concat(c).concat(u).concat(f).concat(g).concat(v);
    ...
    a = e((e, a) => {
        (function (o) {
            ...
            var r = {};
            function i(e) {
                return r[e] || (r[e] = RegExp(`\\s+` + e + `\\s*=\\s*('|")?([^'"]+)('|")?\\s*`));
            }
            function a(e, t) {
                var n = e.match(i(t));
            ...
            function s(e, t) {
                for (var n in e)
                    for (var r = t[n] || (t[n] = []), i = e[n], a = i.length - 1; a >= 0; a--)
                        r.unshift(i[a]);
            }
            function c(e, t) {
