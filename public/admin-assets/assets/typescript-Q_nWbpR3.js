...
var t = {
        ...
        onEnterRules: [
            {
                beforeText: /^\s*\/\*\*(?!\/)([^\*]|\*(?!\/))*$/,
                afterText: /^\s*\*\/$/,
                action: { indentAction: e.IndentAction.IndentOutdent, appendText: ` * ` },
            },
            {
                beforeText: /^\s*\/\*\*(?!\/)([^\*]|\*(?!\/))*$/,
            ...
            {
                beforeText: /^(\t|(\ \ ))*\ \*\/\s*$/,
                action: { indentAction: e.IndentAction.None, removeText: 1 },
            },
        ],
        autoClosingPairs: [
            { open: `{`, close: `}` },
        ...
        folding: {
            markers: {
                start: RegExp(`^\\s*//\\s*#?region\\b`),
                end: RegExp(`^\\s*//\\s*#?endregion\\b`),
            },
        },
    },
    n = {
