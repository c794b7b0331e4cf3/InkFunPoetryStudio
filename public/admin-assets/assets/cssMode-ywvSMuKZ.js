import { a as e, c as t, f as n, m as r, p as i } from "./editor.api-Ck4Uxo0P.js";
import "./monaco-editor-core-CSIW_mLf.js";
var a = 120 * 1e3,
    o = (function () {
        function e(e) {
            var t = this;
        ...
        return (
            ...
            (e.prototype._checkIfIdle = function () {
                this._worker && Date.now() - this._lastUsedTime > a && this._stopWorker();
            }),
            (e.prototype._getClient = function () {
                return (
                    (this._lastUsedTime = Date.now()),
                    (this._client ||=
                        ((this._worker = i.createWebWorker({
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return K.objectLiteral(t) && K.uinteger(t.line) && K.uinteger(t.character);
    }
    e.is = n;
})((l ||= {}));
var u;
(function (e) {
    function t(e, t, n, r) {
        if (K.uinteger(e) && K.uinteger(t) && K.uinteger(n) && K.uinteger(r))
            return { start: l.create(e, t), end: l.create(n, r) };
    ...
    function n(e) {
        var t = e;
        return K.objectLiteral(t) && l.is(t.start) && l.is(t.end);
    }
    e.is = n;
})((u ||= {}));
var d;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return K.defined(t) && u.is(t.range) && (K.string(t.uri) || K.undefined(t.uri));
    }
    e.is = n;
})((d ||= {}));
var f;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            (u.is(t.targetSelectionRange) || K.undefined(t.targetSelectionRange)) &&
            (u.is(t.originSelectionRange) || K.undefined(t.originSelectionRange))
        );
    }
    e.is = n;
})((f ||= {}));
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return (
            K.numberRange(t.red, 0, 1) &&
            K.numberRange(t.green, 0, 1) &&
            K.numberRange(t.blue, 0, 1) &&
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return u.is(t.range) && p.is(t.color);
    }
    e.is = n;
})((m ||= {}));
var h;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            K.string(t.label) &&
            (K.undefined(t.textEdit) || x.is(t)) &&
            (K.undefined(t.additionalTextEdits) || K.typedArray(t.additionalTextEdits, x.is))
        );
    }
    e.is = n;
})((h ||= {}));
...
(function (e) {
    function t(e, t, n, r, i) {
        ...
        return (
            K.defined(n) && (a.startCharacter = n),
            K.defined(r) && (a.endCharacter = r),
            K.defined(i) && (a.kind = i),
            a
        );
    }
    e.create = t;
    function n(e) {
        var t = e;
        return (
            K.uinteger(t.startLine) &&
            K.uinteger(t.startLine) &&
            (K.undefined(t.startCharacter) || K.uinteger(t.startCharacter)) &&
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return K.defined(t) && d.is(t.location) && K.string(t.message);
    }
    e.is = n;
})((_ ||= {}));
var v;
...
(function (e) {
    function t(e, t, n, r, i, a) {
        ...
        return (
            K.defined(n) && (o.severity = n),
            K.defined(r) && (o.code = r),
            K.defined(i) && (o.source = i),
            K.defined(a) && (o.relatedInformation = a),
            o
        );
    }
    e.create = t;
    function n(e) {
        ...
        return (
            ...
            (K.integer(t.code) || K.string(t.code) || K.undefined(t.code)) &&
            (K.undefined(t.codeDescription) || K.string(t.codeDescription?.href)) &&
            (K.string(t.source) || K.undefined(t.source)) &&
            (K.undefined(t.relatedInformation) || K.typedArray(t.relatedInformation, _.is))
        );
    }
    e.is = n;
})((y ||= {}));
...
(function (e) {
    function t(e, t) {
        var n = [...arguments].slice(2),
            r = { title: e, command: t };
        return (K.defined(n) && n.length > 0 && (r.arguments = n), r);
    }
    e.create = t;
    function n(e) {
        var t = e;
...
(function (e) {
    ...
    function i(e) {
        var t = e;
        return K.objectLiteral(t) && K.string(t.newText) && u.is(t.range);
    }
    e.is = i;
})((x ||= {}));
var S;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            K.objectLiteral(t) &&
            K.string(t.label) &&
            (K.boolean(t.needsConfirmation) || t.needsConfirmation === void 0) &&
            (K.string(t.description) || t.description === void 0)
        );
    }
    e.is = n;
})((S ||= {}));
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return K.defined(t) && M.is(t.textDocument) && Array.isArray(t.edits);
    }
    e.is = n;
})((T ||= {}));
var E;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            K.string(t.uri) &&
            (t.options === void 0 ||
                ((t.options.overwrite === void 0 || K.boolean(t.options.overwrite)) &&
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            K.string(t.uri) &&
            (t.options === void 0 ||
                ((t.options.recursive === void 0 || K.boolean(t.options.recursive)) &&
        ...
        return (
            ...
            (t.documentChanges === void 0 ||
                t.documentChanges.every(function (e) {
                    return K.string(e.kind) ? E.is(e) || D.is(e) || O.is(e) : T.is(e);
                }))
        );
    }
    e.is = t;
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return K.defined(t) && K.string(t.uri) && (t.version === null || K.integer(t.version));
    }
    e.is = n;
})((M ||= {}));
var N;
...
(function (e) {
    function t(e) {
        var t = e;
        return K.objectLiteral(e) && P.is(t.kind) && K.string(t.value);
    }
    e.is = t;
})((F ||= {}));
var I;
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return t && K.string(t.newText) && u.is(t.insert) && u.is(t.replace);
    }
    e.is = n;
})((oe ||= {}));
var se;
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return K.string(t) || (K.objectLiteral(t) && K.string(t.language) && K.string(t.value));
    }
    e.is = n;
})((R ||= {}));
var z;
(function (e) {
    function t(e) {
        ...
        return (
            !!t &&
            K.objectLiteral(t) &&
            (F.is(t.contents) || R.is(t.contents) || K.typedArray(t.contents, R.is)) &&
            (e.range === void 0 || u.is(e.range))
        );
    }
    e.is = t;
})((z ||= {}));
...
(function (e) {
    function t(e, t) {
        var n = [...arguments].slice(2),
            r = { label: e };
        return (
            K.defined(t) && (r.documentation = t),
            K.defined(n) ? (r.parameters = n) : (r.parameters = []),
            r
        );
    }
    e.create = t;
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            (t.detail === void 0 || K.string(t.detail)) &&
            (t.deprecated === void 0 || K.boolean(t.deprecated)) &&
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            K.defined(t) &&
            K.typedArray(t.diagnostics, y.is) &&
            (t.only === void 0 || K.typedArray(t.only, K.string))
        );
    }
    e.is = n;
})((me ||= {}));
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            t &&
            K.string(t.title) &&
            (t.diagnostics === void 0 || K.typedArray(t.diagnostics, y.is)) &&
            (t.kind === void 0 || K.string(t.kind)) &&
            (t.edit !== void 0 || t.command !== void 0) &&
            (t.command === void 0 || b.is(t.command)) &&
            (t.isPreferred === void 0 || K.boolean(t.isPreferred)) &&
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return K.defined(t) && u.is(t.range) && (K.undefined(t.command) || b.is(t.command));
    }
    e.is = n;
})((ge ||= {}));
var _e;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return K.defined(t) && K.uinteger(t.tabSize) && K.boolean(t.insertSpaces);
    }
    e.is = n;
})((_e ||= {}));
var ve;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return K.defined(t) && u.is(t.range) && (K.undefined(t.target) || K.string(t.target));
    }
    e.is = n;
})((ve ||= {}));
var ye;
(function (e) {
    ...
    function n(t) {
        var n = t;
        return n !== void 0 && u.is(n.range) && (n.parent === void 0 || e.is(n.parent));
    }
    e.is = n;
})((ye ||= {}));
var G;
...
var xe = (function () {
    function e(e, t, n) {
        ...
        var a = function (e) {
            ...
            o = function (e) {
                i.setModelMarkers(e, r._languageId, []);
                var t = e.uri.toString(),
                    n = r._listener[t];
                n && (n.dispose(), delete r._listener[t]);
            };
        (this._disposables.push(i.onDidCreateModel(a)),
            this._disposables.push(i.onWillDisposeModel(o)),
            this._disposables.push(
                i.onDidChangeModelLanguage(function (e) {
                    (o(e.model), a(e.model));
                }),
            ),
            n.onDidChange(function (e) {
                i.getModels().forEach(function (e) {
                    e.getLanguageId() === r._languageId && (o(e), a(e));
                });
            }),
            this._disposables.push({
                dispose: function () {
...
function Y(e) {
    if (e) return { range: J(e.range), text: e.newText };
}
function De(e) {
...
var Oe = (function () {
    ...
    return (
        ...
        (e.prototype.provideCompletionItems = function (e, n, i, a) {
            var o = e.uri;
            return this._worker(o)
                .then(function (e) {
                    return e.doComplete(o.toString(), q(n));
                })
                .then(function (i) {
                    if (i) {
                        var a = e.getWordUntilPosition(n),
                            o = new t(n.lineNumber, a.startColumn, n.lineNumber, a.endColumn),
                            s = i.items.map(function (e) {
                                ...
                                return (
                                    e.textEdit &&
                                        (Te(e.textEdit)
                                            ? (t.range = {
                                                  insert: J(e.textEdit.insert),
                                                  replace: J(e.textEdit.replace),
                                              })
                                            : (t.range = J(e.textEdit.range)),
                                        (t.insertText = e.textEdit.newText)),
                                    e.additionalTextEdits &&
                                        (t.additionalTextEdits = e.additionalTextEdits.map(Y)),
                                    e.insertTextFormat === L.Snippet &&
                                        (t.insertTextRules =
...
function Ae(e) {
    if (e) return Array.isArray(e) ? e.map(X) : [X(e)];
}
var je = (function () {
    function e(e) {
        this._worker = e;
    ...
    return (
        (e.prototype.provideHover = function (e, t, n) {
            ...
            return this._worker(r)
                .then(function (e) {
                    return e.doHover(r.toString(), q(t));
                })
                .then(function (e) {
                    if (e) return { range: J(e.range), contents: Ae(e.contents) };
                });
        }),
        e
    );
...
var Ne = (function () {
    ...
    return (
        (e.prototype.provideDocumentHighlights = function (e, t, n) {
            ...
            return this._worker(r)
                .then(function (e) {
                    return e.findDocumentHighlights(r.toString(), q(t));
                })
                .then(function (e) {
                    if (e)
                        return e.map(function (e) {
                            return { range: J(e.range), kind: Me(e.kind) };
                        });
                });
        }),
        e
...
function Z(e) {
    return { uri: n.parse(e.uri), range: J(e.range) };
}
var Pe = (function () {
        function e(e) {
            this._worker = e;
        ...
        return (
            (e.prototype.provideDefinition = function (e, t, n) {
                ...
                return this._worker(r)
                    .then(function (e) {
                        return e.findDefinition(r.toString(), q(t));
                    })
                    .then(function (e) {
                        if (e) return [Z(e)];
                    });
        ...
        return (
            (e.prototype.provideReferences = function (e, t, n, r) {
                ...
                return this._worker(i)
                    .then(function (e) {
                        return e.findReferences(i.toString(), q(t));
                    })
                    .then(function (e) {
                        if (e) return e.map(Z);
                    });
...
function Ie(e) {
    if (!(!e || !e.changes)) {
        var t = [];
        for (var r in e.changes)
            for (var i = n.parse(r), a = 0, o = e.changes[r]; a < o.length; a++) {
                var s = o[a];
                t.push({ resource: i, edit: { range: J(s.range), text: s.newText } });
            }
        return { edits: t };
    }
}
var Le = (function () {
    ...
    return (
        (e.prototype.provideRenameEdits = function (e, t, n, r) {
            ...
            return this._worker(i)
                .then(function (e) {
                    return e.doRename(i.toString(), q(t), n);
                })
                .then(function (e) {
                    return Ie(e);
                });
                        ...
                        if (e)
                            return e.map(function (e) {
                                return {
                                    ...
                                    kind: Re(e.kind),
                                    tags: [],
                                    range: J(e.location.range),
                                    selectionRange: J(e.location.range),
                                };
                            });
                    });
            }),
    ...
    Be = (function () {
        ...
        return (
            (e.prototype.provideDocumentColors = function (e, t) {
                ...
                return this._worker(n)
                    ...
                    .then(function (e) {
                        if (e)
                            return e.map(function (e) {
                                return { color: e.color, range: J(e.range) };
                            });
                    });
            }),
            (e.prototype.provideColorPresentations = function (e, t, n) {
                ...
                return this._worker(r)
                    .then(function (e) {
                        return e.getColorPresentations(r.toString(), t.color, we(t.range));
                    })
                    .then(function (e) {
                        if (e)
                            return e.map(function (e) {
                                var t = { label: e.label };
                                return (
                                    e.textEdit && (t.textEdit = Y(e.textEdit)),
                                    e.additionalTextEdits &&
                                        (t.additionalTextEdits = e.additionalTextEdits.map(Y)),
                                    t
                                );
                    ...
                    .then(function (e) {
                        if (e)
                            return e.map(function (e) {
                                ...
                                return (e.kind !== void 0 && (t.kind = He(e.kind)), t);
                            });
                    });
            }),
            e
...
var Ue = (function () {
    ...
    return (
        (e.prototype.provideSelectionRanges = function (e, t, n) {
            ...
            return this._worker(r)
                .then(function (e) {
                    return e.getSelectionRanges(r.toString(), t.map(q));
                })
                .then(function (e) {
                    if (e)
                        return e.map(function (e) {
                            for (var t = []; e; ) (t.push({ range: J(e.range) }), (e = e.parent));
                            return t;
                        });
                });
        }),
...
function We(e) {
    ...
    function s() {
        ...
        ($(n),
            i.completionItems && n.push(r.registerCompletionItemProvider(t, new Oe(a))),
            i.hovers && n.push(r.registerHoverProvider(t, new je(a))),
            i.documentHighlights && n.push(r.registerDocumentHighlightProvider(t, new Ne(a))),
            i.definitions && n.push(r.registerDefinitionProvider(t, new Pe(a))),
            i.references && n.push(r.registerReferenceProvider(t, new Fe(a))),
            i.documentSymbols && n.push(r.registerDocumentSymbolProvider(t, new ze(a))),
            i.rename && n.push(r.registerRenameProvider(t, new Le(a))),
            i.colors && n.push(r.registerColorProvider(t, new Be(a))),
            i.foldingRanges && n.push(r.registerFoldingRangeProvider(t, new Ve(a))),
            i.diagnostics && n.push(new xe(t, a, e)),
            i.selectionRanges && n.push(r.registerSelectionRangeProvider(t, new Ue(a))));
    }
    return (s(), t.push(Q(n)), Q(t));
}
function Q(e) {
    return {
        dispose: function () {
