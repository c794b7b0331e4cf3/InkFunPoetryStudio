...
function b(e) {
    var n = e.className,
        ...
        S = e.iconClassName,
        C = e.titleClassName,
        w = e.subTitleClassName,
        T = e.descriptionClassName,
        E = o(y, _, `| raw`),
        D = (Array.isArray(E) ? E : void 0) || s || [],
        O = d(c) ? o(c, _, `| raw`) : c,
        k = function (e) {
            return typeof e == `string` ? g(e, _) : e && b(`inner`, e);
        },
        A = i(e) ?? 0,
        j = typeof A == `string` && isNaN(+A) ? r(A, _) || A : +A,
        M = D.findIndex(function (e) {
            return e.value && e.value === j;
        }),
        N = M === -1 ? j : M,
        P = D.map(function (e, n) {
            var r = F(e, n);
            return t(t({}, e), {
                status: r,
                title: k(e.title),
                subTitle: k(e.subTitle),
                description: k(e.description),
            });
        });
    function F(e, t) {
        var n;
        if (typeof O == `string`) t === N && (n = O || c || h.process);
...
var x = _()(
                                ...
                                config: {
                                    ...
                                    classNames: [
                                        ...
                                        },
                                        {
                                            ...
                                            weights: {
                                                default: { important: !0, parent: `.is-finish` },
                                            },
                                        },
                                        {
                                            key: `iconControlClassNameProcess`,
                                            weights: {
                                                default: { important: !0, parent: `.is-process` },
                                            },
                                        },
                                        {
                                            key: `iconControlClassNameWait`,
                                            weights: {
                                                default: { important: !0, parent: `.is-wait` },
                                            },
                                        },
                                        {
                                            key: `iconControlClassNameError`,
                                            weights: {
                                                default: { important: !0, parent: `.is-error` },
                                            },
                                        },
                                        {
    ...
    S = (function (e) {
        ...
        return (
            (n.prototype.render = function () {
                return v.createElement(x, t({}, this.props));
            }),
            (n = c([p({ type: `steps` })], n)),
            n
        );
    })(v.Component);
export { b as StepsCmpt, S as StepsRenderer };