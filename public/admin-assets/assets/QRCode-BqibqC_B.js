...
function v(e, t, n) {
    return (
        (n = H(n)),
        `M ${H(e - n)}, ${H(t)} a ${n},${n} 0 1,0 ${2 * n},0 a ${n},${n} 0 1,0 ${-2 * n},0`
    );
}
function y(e, t, n) {
    ((e = H(e)), (t = H(t)));
    let r = H(e + n),
        i = H(t + n);
    return `M ${e}, ${t} L ${r}, ${t} L ${r}, ${i} L ${e}, ${i} Z `;
}
function b(e, t, n, r) {
    ((e = H(e)), (t = H(t)));
    let i = H(e + r),
        ...
        c = H(e + n),
        l = H(t + n);
    return `M${i} ${t}L${c} ${t}L${c} ${l}L${e} ${l}L${e} ${t}L${i} ${t}L${i} ${s}L${o} ${s}L${o} ${a}L${i} ${a}Z `;
}
function x(e, t, n, r, i) {
    ...
    let a = H(e + i),
        ...
        y = H(f - h),
        b = H(a + h);
    return `M${a} ${t}L${o} ${t}A${i} ${i} 0 0 1 ${p} ${s}L${p} ${c}A${i} ${i} 0 0 1 ${o} ${m}L${a} ${m}A${i} ${i} 0 0 1 ${e} ${c}L${e} ${s}A${i} ${i} 0 0 1 ${a} ${t}L${a} ${t}L${b} ${f}L${v} ${f}A${h} ${h} 0 0 0 ${d} ${y}L${d} ${_}A${h} ${h} 0 0 0 ${v} ${u}L${g} ${u}A${h} ${h} 0 0 0 ${l} ${_}L${l} ${y}A${h} ${h} 0 0 0 ${g} ${f}L${b} ${f}Z`;
}
function S(e, t, n, r) {
    let i = H(n),
        a = H(n - r);
    ...
    let o = H(t - i),
        ...
        c = H(t + i),
        l = H(t + a);
    return `M${e},${o} A${i},${i} 0 1,1 ${e},${c} A${i},${i} 0 1,1 ${e},${o} M${e},${s} A${a},${a} 0 1,0 ${e},${l} A${a},${a} 0 1,0 ${e},${s} Z`;
}
function C(e) {
    let { size: t, dotSize: n, borderSize: r, x: i, y: a } = e;
    return { eyeBorder: b(i, a, t, n * r), eyeInner: y(i + n * 2, a + n * 2, t - n * 4) };
}
function w(e) {
    let { size: t, dotSize: n, borderSize: r, x: i, y: a } = e;
    return {
        eyeBorder: x(i, a, t, n * r, n * 2),
        eyeInner: v(i + t / 2, a + t / 2, t / 2 - n * 2),
    };
}
function T(e) {
    let { size: t, dotSize: n, borderSize: r, x: i, y: a } = e;
    return {
        eyeBorder: S(i + t / 2, a + t / 2, t / 2, n * r),
        eyeInner: v(i + t / 2, a + t / 2, t / 2 - n * 2),
    };
}
var E = { default: C, rounded: w, circle: T };
function D(e) {
    let t = { default: 1, sm: 0.8, xs: 0.5 };
    return (n) => {
        let { size: r, dotSize: i, borderSize: a, margin: o } = n,
            { eyeSize: s, positions: c } = z(r, i, o),
            l = ``,
            u = ``;
        for (let n of c) {
            let { eyeBorder: r, eyeInner: o } = e({
                size: s,
                dotSize: i,
                borderSize: t[a],
                x: n.x,
...
function k(e) {
    let { x: t, y: n, dotSize: r, dotScale: i, margin: a } = e,
        o = ``,
        s = r * i;
    return ((o += y(t * r + (r - s) / 2 + a, n * r + (r - s) / 2 + a, s)), o);
}
function A(e) {
    let { x: t, y: n, dotSize: r, dotScale: i, margin: a } = e,
        o = ``,
...
var j = { default: k, circle: A };
function M(e) {
    let t = { default: 1, sm: 0.8, xs: 0.5 };
    return (n) => {
        let { modules: r, dotSize: i, pointSize: a, customSize: o, margin: s } = n,
            c = ``;
        for (let n = 0; n < r.length; n++)
            for (let l = 0; l < r.length; l++)
                if (r[n][l] && !B(r, l, n)) {
                    let r = o[n][l] || 1;
                    c += e({ x: l, y: n, dotSize: i, dotScale: t[a] * r, margin: s });
                }
        return c;
    };
}
...
(((e) => {
    let t = class t {
        ...
        static encodeSegments(e, r, a = 1, s = 40, c = -1, l = !0) {
            ...
            let u, d;
            for (u = a; ; u++) {
                let n = t.getNumDataCodewords(u, r) * 8,
                    i = o.getTotalBits(e, u);
                if (i <= n) {
                    d = i;
                    break;
                }
            ...
            (i(f.length <= p),
                n(0, Math.min(4, p - f.length), f),
                n(0, (8 - (f.length % 8)) % 8, f),
                i(f.length % 8 == 0));
        ...
        drawFormatBits(e) {
            ...
            (this.setFunctionModule(8, 7, r(a, 6)),
                this.setFunctionModule(8, 8, r(a, 7)),
                this.setFunctionModule(7, 8, r(a, 8)));
        ...
        addEccAndInterleave(e) {
            ...
            let a = t.NUM_ERROR_CORRECTION_BLOCKS[r.ordinal][n],
                o = t.ECC_CODEWORDS_PER_BLOCK[r.ordinal][n],
                s = Math.floor(t.getNumRawDataModules(n) / 8),
                c = a - (s % a),
                l = Math.floor(s / a),
                u = [],
                d = t.reedSolomonComputeDivisor(o);
        ...
        drawCodewords(e) {
            ...
            for (let t = this.size - 1; t >= 1; t -= 2) {
                ...
                for (let i = 0; i < this.size; i++)
                    for (let a = 0; a < 2; a++) {
                        let o = t - a,
                            s = (t + 1) & 2 ? i : this.size - 1 - i;
                        !this.isFunction[s][o] &&
                            n < e.length * 8 &&
                            ((this.modules[s][o] = r(e[n >>> 3], 7 - (n & 7))), n++);
                    }
            }
            i(n == e.length * 8);
        }
        ...
        getPenaltyScore() {
            ...
            for (let n = 0; n < this.size; n++) {
                ...
                for (let o = 0; o < this.size; o++)
                    this.modules[n][o] == r
                        ? (i++, i == 5 ? (e += t.PENALTY_N1) : i > 5 && e++)
                        : (this.finderPenaltyAddHistory(i, a),
                          r || (e += this.finderPenaltyCountPatterns(a) * t.PENALTY_N3),
                          (r = this.modules[n][o]),
                          (i = 1));
            ...
            let r = this.size * this.size,
                a = Math.ceil(Math.abs(n * 20 - r * 10) / r) - 1;
    ...
    let a = class e {
        ...
        static makeAlphanumeric(t) {
            ...
            return (
                i < t.length && n(e.ALPHANUMERIC_CHARSET.indexOf(t.charAt(i)), 6, r),
                new e(e.Mode.ALPHANUMERIC, t.length, r)
            );
        }
        ...
        static toUtf8ByteArray(e) {
            ...
            for (let n = 0; n < e.length; n++)
                e.charAt(n) == `%`
                    ? (t.push(parseInt(e.substring(n + 1, n + 3), 16)), (n += 2))
...
function R(e, t) {
    let { level: n = `L`, minVersion: r = 2, maxVersion: i, mask: a, boostLevel: o } = t || {},
        s = F.QrSegment.makeSegments(e),
        c = I.encodeSegments(s, L[n], r, i, a, o),
        l = [];
    for (let e = 0; e < c.size; e++) {
        l.push([]);
        for (let t = 0; t < c.size; t++) l[e].push(c.getModule(t, e));
    }
    return l;
}
function z(e, t, n) {
...
function V(e) {
    let {
            ...
            margin: i = 0,
            eyeType: a = `default`,
            eyeBorderSize: o = `default`,
            pointType: s = `default`,
            customSize: c,
            pointSize: l = `default`,
        } = e,
        u = N(s)({ margin: i, modules: t, dotSize: r, pointSize: l, customSize: c }),
        { eyeBorder: d, eyeInner: f } = O(a)({ margin: i, dotSize: r, borderSize: o, size: n });
    return { points: u, eyeBorder: d, eyeInner: f };
}
function H(e, t = 2) {
    return Number(e.toFixed(t));
}
function U(e) {
    let { config: t, styleConfig: n, logoConfig: r, value: i } = e,
        {
            size: a = 200,
            margin: o = 0,
            eyeType: s,
        ...
        f = _.useMemo(() => R(i, t), [i, t]),
        p = _.useMemo(() => H((a - o * 2) / f.length), [f, a, o]),
        m = _.useMemo(() => {
            let e = [];
            for (let t = 0; t < f.length; t++) {
                e.push([]);
                for (let n = 0; n < f.length; n++)
                    d ? e[t].push(Math.random() < 0.5 ? 1 : 0.8) : e[t].push(1);
            }
            return e;
        }, [f, d]),
        h = _.useMemo(
    ...
    return {
        logo: _.useMemo(() => {
            ...
            let e = a - o * 2,
                ...
                l = f.length,
                u = Array.from({ length: l }, (e, t) => t * p + o),
                d = u[u.findIndex((e) => e > s) - 2] - 0.5 || s,
                m = u[u.findIndex((e) => e > c) - 2] - 0.5 || c;
            return {
                src: t,
                width: n,
                height: i,
                x: s,
                y: c,
                bg: { x: d, y: m, width: n + (s - d) * 2, height: i + (c - m) * 2 },
            };
        }, [f, p, o, r]),
        path: h,
    };
...
function W(e) {
    let { value: t, config: n, styleConfig: r, logoConfig: i, className: a } = e,
        {
            size: o = 200,
            margin: s = 0,
            color: c = `#000`,
        ...
        { path: f, logo: p } = U({ config: n, styleConfig: r, logoConfig: i, value: t }),
        { src: m, x: h, y: g, width: v, height: y, bg: b } = p || {};
    return _.createElement(
        `svg`,
        {
            ...
            className: `qr-container qr-svg` + (a ? ` ${a}` : ``),
        },
        _.createElement(
            `g`,
            { fill: c },
            _.createElement(`path`, { fill: u || c, d: f.eyeBorder }),
            _.createElement(`path`, { fill: d || c, d: f.eyeInner }),
            _.createElement(`path`, { d: f.points }),
            m &&
                _.createElement(
                    _.default.Fragment,
                    null,
                    ...
                    _.createElement(`image`, { href: m, width: v, height: y, x: h, y: g }),
                ),
        ),
    );
}
function G({ ctx: e, bgColor: t = `#fff`, logo: n }) {
    let { src: r, width: i, height: a, x: o, y: s, bg: c } = n || {};
    if (!r) return;
    let l = new Image();
    ((l.src = r),
        (l.onload = () => {
            ((e.fillStyle = t), e.fillRect(c.x, c.y, c.width, c.height));
            let n = l.width / l.height,
                r = i,
                u = a;
            (n > 1 ? (u = i / n) : (r = a * n),
                e.drawImage(l, o + (i - r) / 2, s + (a - u) / 2, r, u));
        }));
}
function K(e) {
    let { ctx: t, path: n, styleConfig: r } = e,
        { color: i = `#000`, bgColor: a = `#fff`, eyeBorderColor: o, eyeInnerColor: s } = r || {};
    (t.clearRect(0, 0, t.canvas.width, t.canvas.height),
        (t.fillStyle = a),
        t.fillRect(0, 0, t.canvas.width, t.canvas.height),
        (t.fillStyle = o || i),
        t.fill(new Path2D(n.eyeBorder)),
        (t.fillStyle = s || i),
        t.fill(new Path2D(n.eyeInner)),
        (t.fillStyle = i),
        t.fill(new Path2D(n.points)));
}
function q(e) {
    let { value: t, config: n, styleConfig: r, logoConfig: i, className: a } = e,
        { size: o = 200, bgColor: s } = r || {},
        { path: c, logo: l } = U({ config: n, styleConfig: r, logoConfig: i, value: t }),
        u = _.useRef(null);
    return (
        (0, _.useEffect)(() => {
            if (c && u.current) {
                let e = u.current.getContext(`2d`);
                (K({ ctx: e, path: c, styleConfig: r }), l && G({ ctx: e, bgColor: s, logo: l }));
            }
        }, [c, i, r]),
        _.createElement(`canvas`, {
            ...
            height: o,
            ref: u,
            className: `qr-container qr-canvas` + (a ? ` ${a}` : ``),
        })
    );
}
function J(e) {
    let { mode: t = `canvas` } = e;
    return t === `svg` ? _.createElement(W, { ...e }) : _.createElement(q, { ...e });
}
var Y = e(u()),
    X = t();
function Z(e, t) {
    return (0, X.saveAs)(e, t);
}
var Q = (function (e) {
        l(t, e);
        function t(t) {
            var n = e.call(this, t) || this;
            return ((n.ref = _.createRef()), n);
        }
        return (
            (t.prototype.getImageSettings = function () {
                var e = this.props,
                    t = e.imageSettings,
                    n = e.data;
                if (!(!t || !s(t) || !t.src || typeof t.src != `string`))
                    return (
                        d(t.src) && (t.src = o(t.src, n, `| raw`)),
                        (0, Y.default)(t, function (e, t) {
                            return ~[`width`, `height`, `x`, `y`].indexOf(t)
                                ? i(e)
                                    ? Number(e)
                                    : null
                                : e;
            ...
            (t.prototype.doAction = function (e, t, n, r) {
                var i = this.props.codeSize;
                if (e?.actionType === `saveAs` && this.ref?.current)
                    if (this.props.mode === `svg`) {
                        var a = this.ref.current.querySelector(`svg`);
                        if (a) {
                            var o = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" height="${i}" width="${i}" viewBox="${a.getAttribute(`viewBox`) || `0 0 37 37`}">
         ${a.innerHTML}
         </svg>`;
                            Z(new Blob([o], { type: `image/svg+xml` }), r?.name || `qr-code.svg`);
                        }
                    } else {
                        var s = this.ref.current.querySelector(`canvas`);
                        s &&
                            s.toBlob(function (e) {
                                e &&
                                    Z(
                                        e,
                                        r?.name ? r.name.replace(/\.svg$/, `.png`) : `qr-code.png`,
                                    );
                            }, `image/png`);
                    }
            }),
            (t.prototype.render = function () {
                var e = this.props,
                    ...
                    C = e.translate,
                    w = e.classPrefix,
                    T = r(this.props, function () {
                        return h(u, d, `| raw`) || void 0;
                    });
                return _.createElement(
                    `div`,
                    { className: (0, g.default)(`${w}QrCode`, t), style: n, ref: this.ref },
                    T
                        ? T.length > 2953
                            ? _.createElement(
                                  `span`,
                                  { className: `text-danger` },
                                  C(`QRCode.tooLong`, { max: 2953 }),
                              )
                            : _.createElement(J, {
                                  className: i,
                                  value: T,
                                  config: { level: l || `L`, minVersion: 2, boostLevel: !0 },
                                  styleConfig: {
                                      size: a,
                                      bgColor: o,
                                      color: s,
                        ...
                        : _.createElement(`span`, { className: `${w}QrCode--placeholder` }, c),
                );
            }),
            (t.defaultProps = {
                codeSize: 128,
    ...
    $ = (function (e) {
        ...
        return (
            ...
            (t = c(
                [
                    m({ type: `qrcode`, alias: [`qr-code`], name: `qrcode` }),
                    n(`design:paramtypes`, [Object, Object]),
                ],
                t,
            )),
            t
...
export { $ as QRCodeRenderer, Q as default };