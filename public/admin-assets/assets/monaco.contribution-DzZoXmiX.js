const __vite__mapDeps = (
    ...
    d = m.f ||
        (m.f = [
            "assets/tsMode-BVxPNHOw.js",
            "assets/editor.api-Ck4Uxo0P.js",
            "assets/editor-D_Zs4rIG.css",
        ]),
) => i.map((i) => d[i]);
import { za as e } from "./index-zRImlZB6.js";
import { m as t, n } from "./editor.api-Ck4Uxo0P.js";
var r = `4.4.4`,
    i;
(function (e) {
    ((e[(e.None = 0)] = `None`),
...
(function (e) {
    ((e[(e.None = 0)] = `None`),
        ...
        (e[(e.ReactJSX = 4)] = `ReactJSX`),
        (e[(e.ReactJSXDev = 5)] = `ReactJSXDev`));
})((a ||= {}));
var o;
(function (e) {
...
var l = (function () {
        function e(e, t, r, i) {
            ((this._onDidChange = new n()),
                (this._onDidExtraLibsChange = new n()),
                (this._extraLibs = Object.create(null)),
                (this._removedExtraLibs = Object.create(null)),
                (this._eagerModelSync = !1),
                this.setCompilerOptions(e),
                this.setDiagnosticsOptions(t),
                this.setWorkerOptions(r),
                this.setInlayHintsOptions(i),
        ...
        return (
                ...
                var n = this,
                    r =
                        t === void 0
                            ...
                            : t;
                if (this._extraLibs[r] && this._extraLibs[r].content === e)
                    return { dispose: function () {} };
                var i = 1;
                return (
                    this._removedExtraLibs[r] && (i = this._removedExtraLibs[r] + 1),
                    this._extraLibs[r] && (i = this._extraLibs[r].version + 1),
                    (this._extraLibs[r] = { content: e, version: i }),
                    this._fireOnDidExtraLibsChangeSoon(),
                    {
                        dispose: function () {
                            var e = n._extraLibs[r];
                            e &&
                                e.version === i &&
                                (delete n._extraLibs[r],
                                (n._removedExtraLibs[r] = i),
                                n._fireOnDidExtraLibsChangeSoon());
                        },
                    }
                );
            }),
            (e.prototype.setExtraLibs = function (e) {
                for (var t in this._extraLibs)
                    this._removedExtraLibs[t] = this._extraLibs[t].version;
                if (((this._extraLibs = Object.create(null)), e && e.length > 0))
                    for (var n = 0, r = e; n < r.length; n++) {
                        var i = r[n],
                            ...
                            a = i.content,
                            o = 1;
                        (this._removedExtraLibs[t] && (o = this._removedExtraLibs[t] + 1),
                            (this._extraLibs[t] = { content: a, version: o }));
                    }
                this._fireOnDidExtraLibsChangeSoon();
            }),
            (e.prototype._fireOnDidExtraLibsChangeSoon = function () {
                ...
                this._onDidExtraLibsChangeTimeout === -1 &&
                    (this._onDidExtraLibsChangeTimeout = window.setTimeout(function () {
                        ((e._onDidExtraLibsChangeTimeout = -1),
                            e._onDidExtraLibsChange.fire(void 0));
                    }, 0));
            }),
            ...
            (e.prototype.setInlayHintsOptions = function (e) {
                ((this._inlayHintsOptions = e || Object.create(null)),
                    this._onDidChange.fire(void 0));
            }),
    ...
    u = r,
    d = new l(
        { allowNonTsExtensions: !0, target: s.Latest },
        { noSemanticValidation: !1, noSyntaxValidation: !1, onlyVisible: !1 },
        {},
        {},
    ),
    f = new l(
        { allowNonTsExtensions: !0, allowJs: !0, target: s.Latest },
...
t.typescript = {
    ...
    NewLineKind: o,
    ScriptTarget: s,
    ModuleResolutionKind: c,
    typescriptVersion: u,
    typescriptDefaults: d,
    javascriptDefaults: f,
...
function p() {
    return e(() => import(`./tsMode-BVxPNHOw.js`), __vite__mapDeps([0, 1, 2]));
}
(t.onLanguage(`typescript`, function () {
    return p().then(function (e) {
        return e.setupTypeScript(d);
    });
}),
    t.onLanguage(`javascript`, function () {
        return p().then(function (e) {
            return e.setupJavaScript(f);
        });
    }));
export { d as t };