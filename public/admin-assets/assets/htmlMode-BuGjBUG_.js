import { c as e, f as t, m as n, p as r } from "./editor.api-Ck4Uxo0P.js";
import "./monaco-editor-core-B8ls8UxL.js";
var i = 120 * 1e3,
    a = (function () {
        function e(e) {
            var t = this;
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return I.objectLiteral(t) && I.uinteger(t.line) && I.uinteger(t.character);
    }
    e.is = n;
})((c ||= {}));
var l;
(function (e) {
    function t(e, t, n, r) {
        if (I.uinteger(e) && I.uinteger(t) && I.uinteger(n) && I.uinteger(r))
    ...
    function n(e) {
        var t = e;
        return I.objectLiteral(t) && c.is(t.start) && c.is(t.end);
    }
    e.is = n;
})((l ||= {}));
var u;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return I.defined(t) && l.is(t.range) && (I.string(t.uri) || I.undefined(t.uri));
    }
    e.is = n;
})((u ||= {}));
var d;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            (l.is(t.targetSelectionRange) || I.undefined(t.targetSelectionRange)) &&
            (l.is(t.originSelectionRange) || I.undefined(t.originSelectionRange))
        );
    }
    e.is = n;
})((d ||= {}));
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            I.string(t.label) &&
            (I.undefined(t.textEdit) || _.is(t)) &&
            (I.undefined(t.additionalTextEdits) || I.typedArray(t.additionalTextEdits, _.is))
        );
    }
    e.is = n;
})((te ||= {}));
...
(function (e) {
    function t(e, t, n, r, i) {
        ...
        return (
            I.defined(n) && (a.startCharacter = n),
            I.defined(r) && (a.endCharacter = r),
            I.defined(i) && (a.kind = i),
            a
        );
    }
    e.create = t;
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return I.defined(t) && u.is(t.location) && I.string(t.message);
    }
    e.is = n;
})((m ||= {}));
var re;
...
(function (e) {
    function t(e, t, n, r, i, a) {
        ...
        return (
            I.defined(n) && (o.severity = n),
            I.defined(r) && (o.code = r),
            I.defined(i) && (o.source = i),
            I.defined(a) && (o.relatedInformation = a),
            o
        );
    }
    e.create = t;
    function n(e) {
        ...
        return (
            ...
            (I.integer(t.code) || I.string(t.code) || I.undefined(t.code)) &&
            (I.undefined(t.codeDescription) || I.string(t.codeDescription?.href)) &&
            (I.string(t.source) || I.undefined(t.source)) &&
            (I.undefined(t.relatedInformation) || I.typedArray(t.relatedInformation, m.is))
        );
    }
    e.is = n;
})((h ||= {}));
...
(function (e) {
    function t(e, t) {
        var n = [...arguments].slice(2),
            r = { title: e, command: t };
        return (I.defined(n) && n.length > 0 && (r.arguments = n), r);
    }
    e.create = t;
    function n(e) {
        var t = e;
...
(function (e) {
    ...
    function i(e) {
        var t = e;
        return I.objectLiteral(t) && I.string(t.newText) && l.is(t.range);
    }
    e.is = i;
})((_ ||= {}));
var v;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            I.objectLiteral(t) &&
            I.string(t.label) &&
            (I.boolean(t.needsConfirmation) || t.needsConfirmation === void 0) &&
            (I.string(t.description) || t.description === void 0)
        );
    }
    e.is = n;
})((v ||= {}));
...
(function (e) {
    ...
    function i(e) {
        var t = e;
        return _.is(t) && (v.is(t.annotationId) || y.is(t.annotationId));
    }
    e.is = i;
})((b ||= {}));
var x;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return I.defined(t) && O.is(t.textDocument) && Array.isArray(t.edits);
    }
    e.is = n;
})((x ||= {}));
var S;
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            I.string(t.uri) &&
            (t.options === void 0 ||
                ((t.options.overwrite === void 0 || I.boolean(t.options.overwrite)) &&
                    (t.options.ignoreIfExists === void 0 ||
                        I.boolean(t.options.ignoreIfExists)))) &&
            (t.annotationId === void 0 || y.is(t.annotationId))
        );
    }
    e.is = n;
})((S ||= {}));
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            I.string(t.uri) &&
            (t.options === void 0 ||
                ((t.options.recursive === void 0 || I.boolean(t.options.recursive)) &&
        ...
        return (
            ...
            (t.documentChanges === void 0 ||
                t.documentChanges.every(function (e) {
                    return I.string(e.kind) ? S.is(e) || C.is(e) || w.is(e) : x.is(e);
                }))
        );
    }
    e.is = t;
    ...
    return (
            ...
            if (O.is(e)) {
                ...
                if (!n) {
                    ...
                    (this._workspaceEdit.documentChanges.push(i),
                        (n = new E(r, this._changeAnnotations)),
        ...
        (e.prototype.createFile = function (e, t, n) {
            if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw Error(`Workspace edit is not configured for document changes.`);
            var r;
            v.is(t) || y.is(t) ? (r = t) : (n = t);
            var i, a;
            if (
                (r === void 0
                    ? (i = S.create(e, n))
                    : ((a = y.is(r) ? r : this._changeAnnotations.manage(r)),
                      (i = S.create(e, n, a))),
                this._workspaceEdit.documentChanges.push(i),
                a !== void 0)
            )
        ...
        (e.prototype.renameFile = function (e, t, n, r) {
            if ((this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0))
                throw Error(`Workspace edit is not configured for document changes.`);
            var i;
            v.is(n) || y.is(n) ? (i = n) : (r = n);
            var a, o;
            if (
                (i === void 0
                    ? (a = C.create(e, t, r))
                    : ((o = y.is(i) ? i : this._changeAnnotations.manage(i)),
                      (a = C.create(e, t, r, o))),
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return I.defined(t) && I.string(t.uri) && (t.version === null || I.integer(t.version));
    }
    e.is = n;
})((O ||= {}));
var ce;
...
(function (e) {
    function t(e) {
        var t = e;
        return I.objectLiteral(e) && k.is(t.kind) && I.string(t.value);
    }
    e.is = t;
})((A ||= {}));
var j;
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return t && I.string(t.newText) && l.is(t.insert) && l.is(t.replace);
    }
    e.is = n;
})((ue ||= {}));
var de;
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return I.string(t) || (I.objectLiteral(t) && I.string(t.language) && I.string(t.value));
    }
    e.is = n;
})((N ||= {}));
var me;
(function (e) {
    function t(e) {
        ...
        return (
            !!t &&
            I.objectLiteral(t) &&
            (A.is(t.contents) || N.is(t.contents) || I.typedArray(t.contents, N.is)) &&
...
(function (e) {
    function t(e, t) {
        var n = [...arguments].slice(2),
            r = { label: e };
        return (
            I.defined(t) && (r.documentation = t),
            I.defined(n) ? (r.parameters = n) : (r.parameters = []),
            r
        );
    }
    e.create = t;
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            ...
            (t.detail === void 0 || I.string(t.detail)) &&
            (t.deprecated === void 0 || I.boolean(t.deprecated)) &&
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            I.defined(t) &&
            I.typedArray(t.diagnostics, h.is) &&
            (t.only === void 0 || I.typedArray(t.only, I.string))
        );
    }
    e.is = n;
})((Se ||= {}));
...
(function (e) {
    ...
    function n(e) {
        ...
        return (
            t &&
            I.string(t.title) &&
            (t.diagnostics === void 0 || I.typedArray(t.diagnostics, h.is)) &&
            (t.kind === void 0 || I.string(t.kind)) &&
            (t.edit !== void 0 || t.command !== void 0) &&
            (t.command === void 0 || g.is(t.command)) &&
            (t.isPreferred === void 0 || I.boolean(t.isPreferred)) &&
            (t.edit === void 0 || T.is(t.edit))
        );
    }
    e.is = n;
})((Ce ||= {}));
...
(function (e) {
    ...
    function n(e) {
        var t = e;
        return I.defined(t) && l.is(t.range) && (I.undefined(t.command) || g.is(t.command));
    }
    e.is = n;
})((we ||= {}));
var Te;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return I.defined(t) && I.uinteger(t.tabSize) && I.boolean(t.insertSpaces);
    }
    e.is = n;
})((Te ||= {}));
var Ee;
(function (e) {
    ...
    function n(e) {
        var t = e;
        return I.defined(t) && l.is(t.range) && (I.undefined(t.target) || I.string(t.target));
    }
    e.is = n;
})((Ee ||= {}));
var De;
...
function Ae(e) {
    if (e) return { start: L(e.getStartPosition()), end: L(e.getEndPosition()) };
}
function R(t) {
    if (t)
        return new e(t.start.line + 1, t.start.character + 1, t.end.line + 1, t.end.character + 1);
}
function je(e) {
...
function z(e) {
    if (e) return { range: R(e.range), text: e.newText };
}
function Ne(e) {
...
var B = (function () {
    ...
    return (
        ...
        (t.prototype.provideCompletionItems = function (t, r, i, a) {
            var o = t.uri;
            return this._worker(o)
                .then(function (e) {
                    return e.doComplete(o.toString(), L(r));
                })
                .then(function (i) {
                    if (i) {
                        var a = t.getWordUntilPosition(r),
                            o = new e(r.lineNumber, a.startColumn, r.lineNumber, a.endColumn),
                            s = i.items.map(function (e) {
                                ...
                                return (
                                    e.textEdit &&
                                        (je(e.textEdit)
                                            ? (t.range = {
                                                  insert: R(e.textEdit.insert),
                                                  replace: R(e.textEdit.replace),
                                              })
                                            : (t.range = R(e.textEdit.range)),
                                        (t.insertText = e.textEdit.newText)),
                                    e.additionalTextEdits &&
                                        (t.additionalTextEdits = e.additionalTextEdits.map(z)),
...
function Fe(e) {
    if (e) return Array.isArray(e) ? e.map(V) : [V(e)];
}
var H = (function () {
    function e(e) {
        this._worker = e;
    ...
    return (
        (e.prototype.provideHover = function (e, t, n) {
            ...
            return this._worker(r)
                .then(function (e) {
                    return e.doHover(r.toString(), L(t));
                })
                .then(function (e) {
                    if (e) return { range: R(e.range), contents: Fe(e.contents) };
                });
        }),
        e
    );
...
var U = (function () {
    ...
    return (
        (e.prototype.provideDocumentHighlights = function (e, t, n) {
            ...
            return this._worker(r)
                .then(function (e) {
                    return e.findDocumentHighlights(r.toString(), L(t));
                })
                .then(function (e) {
                    if (e)
                        return e.map(function (e) {
                            return { range: R(e.range), kind: Ie(e.kind) };
                        });
                });
        }),
        e
                        ...
                        if (e)
                            return e.map(function (e) {
                                return {
                                    ...
                                    kind: Le(e.kind),
                                    tags: [],
                                    range: R(e.location.range),
                                    selectionRange: R(e.location.range),
                                };
                            });
                    });
            }),
                        ...
                        if (e)
                            return {
                                links: e.map(function (e) {
                                    return { range: R(e.range), url: e.target };
                                }),
                            };
                    });
            }),
        ...
        return (
            (e.prototype.provideDocumentFormattingEdits = function (e, t, n) {
                ...
                return this._worker(r).then(function (e) {
                    return e.format(r.toString(), null, K(t)).then(function (e) {
                        if (!(!e || e.length === 0)) return e.map(z);
                    });
                });
            }),
            e
        ...
        return (
            (e.prototype.provideDocumentRangeFormattingEdits = function (e, t, n, r) {
                ...
                return this._worker(i).then(function (e) {
                    return e.format(i.toString(), Ae(t), K(n)).then(function (e) {
                        if (!(!e || e.length === 0)) return e.map(z);
                    });
                });
            }),
        ...
        return (
            (e.prototype.provideRenameEdits = function (e, t, n, r) {
                ...
                return this._worker(i)
                    .then(function (e) {
                        return e.doRename(i.toString(), L(t), n);
                    })
                    .then(function (e) {
                        return Re(e);
                    });
...
function Re(e) {
    if (!(!e || !e.changes)) {
        ...
        for (var r in e.changes)
            for (var i = t.parse(r), a = 0, o = e.changes[r]; a < o.length; a++) {
                var s = o[a];
                n.push({ resource: i, edit: { range: R(s.range), text: s.newText } });
            }
        return { edits: n };
    }
}
                ...
                .then(function (e) {
                    if (e)
                        return e.map(function (e) {
                            ...
                            return (e.kind !== void 0 && (t.kind = ze(e.kind)), t);
                        });
                });
        }),
        e
...
var Z = (function () {
    ...
    return (
        (e.prototype.provideSelectionRanges = function (e, t, n) {
            ...
            return this._worker(r)
                .then(function (e) {
                    return e.getSelectionRanges(r.toString(), t.map(L));
                })
                .then(function (e) {
                    if (e)
                        return e.map(function (e) {
                            for (var t = []; e; ) (t.push({ range: R(e.range) }), (e = e.parent));
                            return t;
                        });
                });
        }),
...
function Be(e) {
    var t = new a(e),
        ...
        i = e.languageId;
    (n.registerCompletionItemProvider(i, new B(r)),
        n.registerHoverProvider(i, new H(r)),
        n.registerDocumentHighlightProvider(i, new U(r)),
        n.registerLinkProvider(i, new G(r)),
        n.registerFoldingRangeProvider(i, new X(r)),
        n.registerDocumentSymbolProvider(i, new W(r)),
        n.registerSelectionRangeProvider(i, new Z(r)),
        n.registerRenameProvider(i, new Y(r)),
        i === `html` &&
            (n.registerDocumentFormattingEditProvider(i, new q(r)),
            n.registerDocumentRangeFormattingEditProvider(i, new J(r))));
}
function Ve(e) {
    var t = [],
        r = [],
    ...
    function s() {
        ...
        ($(r),
            i.completionItems && r.push(n.registerCompletionItemProvider(t, new B(o))),
            i.hovers && r.push(n.registerHoverProvider(t, new H(o))),
            i.documentHighlights && r.push(n.registerDocumentHighlightProvider(t, new U(o))),
            i.links && r.push(n.registerLinkProvider(t, new G(o))),
            i.documentSymbols && r.push(n.registerDocumentSymbolProvider(t, new W(o))),
            i.rename && r.push(n.registerRenameProvider(t, new Y(o))),
            i.foldingRanges && r.push(n.registerFoldingRangeProvider(t, new X(o))),
            i.selectionRanges && r.push(n.registerSelectionRangeProvider(t, new Z(o))),
            i.documentFormattingEdits &&
                r.push(n.registerDocumentFormattingEditProvider(t, new q(o))),
            i.documentRangeFormattingEdits &&
                r.push(n.registerDocumentRangeFormattingEditProvider(t, new J(o))));
    }
    return (s(), t.push(Q(r)), Q(t));
}
function Q(e) {
    return {
        dispose: function () {
...
export { Ve as setupMode, Be as setupMode1 };