...
var t = e((e, t) => {
    ((n, r) => {
        typeof define == `function` && define.amd
            ? define([], r)
            : typeof t == `object` && e !== void 0
              ? (t.exports = r())
              : (n.Papa = r());
    })(e, function e() {
        var t = typeof self < `u` ? self : typeof window < `u` ? window : t === void 0 ? {} : t,
            n,
            ...
            ((this._handle = null),
                ...
                (this.parseChunk = function (e, n) {
                    ...
                    if (this.isFirstChunk && 0 < r) {
                        ...
                        ((t ||=
                            ...
                            this._handle.guessLineEndings(e, a))),
                            (e = [...e.split(t).slice(r)].join(t)));
                    }
                    (this.isFirstChunk &&
                        x(this._config.beforeFirstChunk) &&
                        (a = this._config.beforeFirstChunk(e)) !== void 0 &&
                        (e = a),
                        (this.isFirstChunk = !1),
                        (this._halted = !1));
                    ...
                    if (!this._handle.paused() && !this._handle.aborted()) {
                        if (
                            ...
                            t.postMessage({ results: a, workerId: s.WORKER_ID, finished: r });
                        ...
                        return (
                            ...
                            this._completed ||
                                ...
                                (this._completed = !0)),
                            r || (a && a.meta.paused) || this._nextChunk(),
                            a
                        );
                    }
                    this._halted = !0;
                ...
                (this._sendError = function (e) {
                    x(this._config.error)
                        ...
                        : i &&
                          this._config.error &&
                          t.postMessage({ workerId: s.WORKER_ID, error: e, finished: !1 });
                }));
        }
        function l(e) {
            var t;
                        ...
                        (t.status < 200 || 400 <= t.status
                            ...
                            : ((this._start += this._config.chunkSize || t.responseText.length),
                              (this._finished =
                                  ...
                                  this._start >=
                                      ((e) =>
                                          (e = e.getResponseHeader(`Content-Range`)) === null
                                              ? -1
                                              : parseInt(e.substring(e.lastIndexOf(`/`) + 1)))(t)),
        ...
        function u(e) {
            ...
            ((this.stream = function (e) {
                ((this._input = e),
                    ...
                    r
                        ? (((t = new FileReader()).onload = b(this._chunkLoaded, this)),
                          (t.onerror = b(this._chunkError, this)))
                ...
                (this._nextChunk = function () {
                    ...
                    if (!this._finished)
                        return (
                            ...
                            (t = e ? ((n = t.substring(0, e)), t.substring(e)) : ((n = t), ``)),
                            (this._finished = !t),
                            this.parseChunk(n)
                        );
                }));
            ...
            function S() {
                                          ...
                                          (((e) => {
                                              ...
                                              : l.test(n)
                                                ...
                                                : n === ``
                                                  ...
                                                  : n))
                                    : n)(
                                (s = e.header ? (i >= _.length ? `__parsed_extra` : _[i]) : s),
                ...
                v &&
                    ...
                    !v.data.length || Array.isArray(v.data[0])
                        ? ((v.data = v.data.map(n)), (i = v.data.length))
                        : (v.data = n(v.data, 0)),
                            ...
                            : (S(),
                              v.data.length !== 0 &&
                                  ...
                                  e.preview && d > e.preview
                                      ? n.abort()
                                      : ((v.data = v.data[0]), i(v, u)))));
                })),
                (this.parse = function (i, a, o) {
                    var c = e.quoteChar || `"`,
                        c =
                            ((e.newline ||= this.guessLineEndings(i, c)),
                            (r = !1),
                            e.delimiter
                                ? x(e.delimiter) &&
                                  ((e.delimiter = e.delimiter(i)), (v.meta.delimiter = e.delimiter))
                                : ((c = ((t, n, r, i, a) => {
                                      var o, c, l, u;
                                              ...
                                              r && b(v.data[y])
                                                  ...
                                                  : ((f = v.data[y].length),
                                                    ...
                                                    l === void 0
                                                        ...
                                                        : 0 < f &&
                                                          ((m += Math.abs(f - l)), (l = f)));
                                          (0 < v.data.length && (g /= v.data.length - _),
                                              (c === void 0 || m <= c) &&
                                                  (u === void 0 || u < g) &&
                                                  1.99 < g &&
                                                  ((c = m), (o = p), (u = g)));
...
`
        ...
        function h(e) {
            var t = (e ||= {}).delimiter,
                ...
                c = null,
                l = !1,
                u = e.quoteChar == null ? `"` : e.quoteChar,
                d = u;
            if (
                (e.escapeChar !== void 0 && (d = e.escapeChar),
                (typeof t != `string` || -1 < s.BAD_DELIMITERS.indexOf(t)) && (t = `,`),
                r === t)
            )
                throw Error(`Comment character same as delimiter`);
            (!0 === r
                ? (r = `#`)
                : (typeof r != `string` || -1 < s.BAD_DELIMITERS.indexOf(r)) && (r = !1),
                n !==
                    `
` &&
                    n !== `\r` &&
...
`));
            ...
            ((this.parse = function (s, h, g) {
                ...
                for (
                    var k = s.indexOf(t, f),
                        A = s.indexOf(n, f),
                        j = new RegExp(m(d) + m(u), `g`),
                        M = s.indexOf(u, f);
                    ;
                )
                    if (s[f] === u)
                        for (M = f, f++; ; ) {
                            if ((M = s.indexOf(u, M + 1)) === -1)
                                return (
                                    g ||
                                        w.push({
                                            type: `Quotes`,
                            ...
                            if (u === d && s[M + 1] === d) M++;
                                ...
                                var N = F(
                                    (A = A !== -1 && A < M + 1 ? s.indexOf(n, M + 1) : A) === -1
                                        ? k
                                        : Math.min(k, A),
                                );
                                if (s.substr(M + 1 + N, v) === t) {
                                    (T.push(s.substring(f, M).replace(j, u)),
                                        s[(f = M + 1 + N + v)] !== u && (M = s.indexOf(u, f)),
                                        (k = s.indexOf(t, f)),
                                        (A = s.indexOf(n, f)));
                                    break;
                                }
                        ...
                        (T.push(s.substring(f, k)), (f = k + v), (k = s.indexOf(t, f)));
                    else {
                        if (A === -1) break;
                ...
                function F(e) {
                    var t = 0;
                    return (t =
                        e !== -1 && (e = s.substring(M + 1, e)) && e.trim() === `` ? e.length : t);
                }
                function I(e) {
                    return (
                        g ||
                            (e === void 0 && (e = s.substring(f)),
                            T.push(e),
                            (f = _),
                            P(T),
                            S && z()),
        ...
        function g(e) {
            ...
            if (t.error) n.userError(t.error, t.file);
                ...
                var i = {
                    abort: function () {
                        ((r = !0), _(t.workerId, { data: [], errors: [], meta: { aborted: !0 } }));
                    },
                    pause: v,
                    resume: v,
                };
        ...
        return (
            (s.parse = function (n, r) {
                var i = (r ||= {}).dynamicTyping || !1;
                if (
                    (x(i) && ((r.dynamicTypingFunction = i), (i = {})),
                    (r.dynamicTyping = i),
                    ...
                    return (
                        ...
                        s.NODE_STREAM_INPUT,
                        typeof n == `string`
                            ? ((n = ((e) => (e.charCodeAt(0) === 65279 ? e.slice(1) : e))(n)),
                              (i = new (r.download ? l : d)(r)))
                ...
                (((i = (() => {
                    ...
                    return (
                        ...
                        ((n = (() => {
                            var n = t.URL || t.webkitURL || null,
                                r = e.toString();
                            return (s.BLOB_URL ||= n.createObjectURL(
                                new Blob(
                                    [
                    ...
                    (r.error = x(r.error)),
                    delete r.worker,
                    i.postMessage({ input: n, config: r, workerId: i.id }));
            }),
                        ...
                        ((() => {
                            if (typeof t == `object`) {
                                if (
                                    ...
                                    typeof t.quoteChar == `string` && (o = t.quoteChar),
                                ...
                                (t.escapeChar !== void 0 && (c = t.escapeChar + o),
                ...
                function p(e, t, n) {
                    ...
                    for (var u = 0; u < t.length; u++) {
                        var d = (s ? e : t[u]).length,
                            f = !1,
                            p = s ? Object.keys(t[u]).length === 0 : t[u].length === 0;
                        if (
                            (n &&
                                !s &&
                                (f =
                ...
                function h(e, t) {
                    ...
                    return e == null
                        ...
                        : e.constructor === Date
                          ...
                          : ((a = !1),
                            d && typeof e == `string` && d.test(e) && ((e = `'` + e), (a = !0)),
                            (r = e.toString().replace(f, c)),
                            (a =
                                a ||
                                !0 === n ||
...
`,
            ...
            (s.WORKERS_SUPPORTED = !r && !!t.Worker),
            ...
            t.jQuery &&
                ((n = t.jQuery).fn.parse = function (e) {
                    var r = e.config || {},
                        i = [];
                    return (
                                ...
                                if (typeof u == `object`) {
                                    if (u.action === `abort`)
                                        return (
                                            ...
                                            (a = l.inputElem),
                                            (c = u.reason),
                                            void (x(e.error) && e.error({ name: t }, r, a, c))
                                        );
                                    if (u.action === `skip`) return void o();
                                    typeof u.config == `object` &&
                                        (l.instanceConfig = n.extend(l.instanceConfig, u.config));
            ...
            i &&
                (t.onmessage = function (e) {
                    ((e = e.data),
                        s.WORKER_ID === void 0 && e && (s.WORKER_ID = e.workerId),
                        typeof e.input == `string`
                            ...
                            : ((t.File && e.input instanceof File) || e.input instanceof Object) &&
                              (e = s.parse(e.input, e.config)) &&
                              t.postMessage({ workerId: s.WORKER_ID, results: e, finished: !0 }));
                }),
